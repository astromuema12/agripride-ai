    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <Input
          ...
          className={`h-10 bg-[var(--card)]/50 backdrop-blur-sm border-[var(--border)] text-sm transition-all duration-200 focus:border-[#0f766e] focus:ring-2 focus:ring-[#0f766e]/20 ${error ? 'border-red-400 focus:border-red-400 focus:ring-red-500/20' : ''}`}
        />
        {showToggle && (
          <button
            type="button"
...
function AuthForm() {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-3.5rem)] sm:min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden bg-gradient-to-br from-[#e2f0ee] via-white to-[#f5ede6] dark:from-[#0a201c] dark:via-[#11201C] dark:to-[#2c140c]/30 px-4 py-8 sm:py-12">
      {/* Background decorations */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-40 -top-40 h-80 w-80 rounded-full bg-[#e2f0ee]/40 blur-3xl dark:bg-[#0f766e]/20" />
        <div className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-[#f5ede6]/30 blur-3xl dark:bg-[#603820]/20" />
        <div className="absolute left-1/2 top-1/2 h-60 w-60 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#14b8a6]/20 blur-3xl dark:bg-[#14b8a6]/10" />
      </div>
      ...
      >
        ...
        <div className="mb-8 text-center">
          <motion.div
            ...
            className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0f766e] to-[#183028] shadow-lg shadow-[#0f766e]/30 dark:shadow-[#0f766e]/30"
          >
                  ...
                  <Tabs value={tab} onValueChange={switchTab} className="w-full">
                    <div className="px-6 pt-6">
                      <TabsList className="grid w-full grid-cols-2 rounded-xl bg-[var(--muted)] p-1">
                        <TabsTrigger value="login" className="rounded-lg text-sm font-medium data-[state=active]:bg-[var(--card)] data-[state=active]:text-[#0f766e] data-[state=active]:shadow-sm dark:data-[state=active]:bg-[#0f766e]/30">{t('auth.title')}</TabsTrigger>
                        <TabsTrigger value="register" className="rounded-lg text-sm font-medium data-[state=active]:bg-[var(--card)] data-[state=active]:text-[#0f766e] data-[state=active]:shadow-sm dark:data-[state=active]:bg-[#0f766e]/30">{t('auth.register')}</TabsTrigger>
                      </TabsList>
                    </div>
                    ...
                    <TabsContent value="login" className="px-6 pb-6 pt-4 mt-0">
                        ...
                        <div className="flex items-center justify-between">
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input
                              ...
                              className="h-4 w-4 rounded border-[var(--border)] text-[#0f766e] focus:ring-[#0f766e] focus:ring-offset-0"
                            />
                          ...
                          <button
                            ...
                            className="text-sm text-[#0f766e] hover:text-[#183028] dark:text-[#14b8a6] dark:hover:text-[#6ee7b7] font-medium"
                          >
                      ...
                      <p className="mt-6 text-center text-sm text-[var(--muted-foreground)]">
                        ...
                        <button
                          ...
                          className="text-[#0f766e] hover:text-[#183028] dark:text-[#14b8a6] dark:hover:text-[#6ee7b7] font-medium"
                        >
                          {t('auth.signUp')}
                        </button>
                      </p>
                      ...
                      <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <label className="flex items-start gap-2 cursor-pointer">
                          <input
                            ...
                            className="mt-0.5 h-4 w-4 shrink-0 rounded border-[var(--border)] text-[#0f766e] focus:ring-[#0f766e] focus:ring-offset-0"
                          />
...
export default function AuthPage() {
  return (
    <Suspense fallback={
      <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-gradient-to-br from-[#e2f0ee] via-white to-[#f5ede6] dark:from-[#0a201c] dark:via-[#11201C] dark:to-[#2c140c]/30">
        <div className="flex flex-col items-center gap-3">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0f766e] to-[#183028] shadow-lg">
            <Wheat className="h-8 w-8 text-white" />
          </div>
