                ...
                <Card key={item.label} className="transition-shadow hover:shadow-md">
                  <CardContent className="flex items-center gap-4 p-5">
                    ...
                    <div>
                      ...
                      {item.href ? (
                        <a href={item.href} className="text-sm font-semibold text-gray-900 hover:text-emerald-600 transition-colors">
                          {item.value}
                        </a>
                      ) : (
            ...
            <Card>
              <CardContent className="p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  <a href="https://www.linkedin.com/in/edwin-musau-b8363a318" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-blue-50 px-3 py-2 text-xs font-medium text-blue-700 hover:bg-blue-100 transition-colors">LinkedIn</a>
                  <a href="https://www.facebook.com/share/18D8KpS3Ut/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-blue-50 px-3 py-2 text-xs font-medium text-blue-700 hover:bg-blue-100 transition-colors">Facebook</a>
                  <a href="https://www.instagram.com/edwin_musau" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-pink-50 px-3 py-2 text-xs font-medium text-pink-700 hover:bg-pink-100 transition-colors">Instagram</a>
                </div>
              </CardContent>
            </Card>
          </motion.div>
